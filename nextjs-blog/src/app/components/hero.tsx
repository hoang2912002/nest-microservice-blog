        ...
        <div className='bg-gradient-to-br from-sky-500 to-indigo-500 text-white pt-12'>
            <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
                <div className="flex flex-col w-full justify-center items-start md:w-2/5 text-center md:text-left">
                    <p className="capitalize tracking-wide w-full">Explore insights, tutorials, and stories for curious mind like yours</p>
                    <h2 className="my-5 text-5xl font-bold leading-tight">Welcome To Lilmet Blog</h2>
                    <p className="capitalize leading-normal text-xl">
                        Join a community that thrives on learning, creating and growing togather.{""}
                    </p>
                </div>
